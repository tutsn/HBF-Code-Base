...
#define PCA_TFRAME     790L    /* no idea//tom// 790us frame time */
#define PCA_TIDLE      35L     /* no idea//tom// 35us idle time */

/* PCA9685 Library Definitions */
#define PCA9685_EXCLUDE_EXT_FUNC        1     /* Proxy Adresser (control all connected PCAs on one instance)*/
#define PCA9685_EXCLUDE_SERVO_EVAL      1     /* Servo functions not needed for LEDs */
#define PCA9685_ENABLE_DEBUG_OUTPUT     0
#define BUFFER_LENGTH 32                      /* Send all 16 Channels in one Package */
